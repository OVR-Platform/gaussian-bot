...
from diffusers.loaders import FromOriginalModelMixin as FromOriginalVAEMixin  # renamed >=0.27
from diffusers.loaders.peft import PeftAdapterMixin  # add_adapter() moved here from ModelMixin
