...
from diffusers.models.embeddings import (
    ...
    ImageProjection,
    ImageTimeEmbedding,
    GLIGENTextBoundingboxProjection as PositionNet,  # renamed in diffusers >=0.27
    TextImageProjection,
...
from diffusers.models.unets.unet_2d_blocks import (  # moved under unets/ in diffusers >=0.27
    UNetMidBlock2D,
